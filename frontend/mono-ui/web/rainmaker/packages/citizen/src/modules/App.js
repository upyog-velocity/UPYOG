      ...
      <div>
        ...
        {!loginScreens && <div style={{ width: '100%', display: 'flex', flexFlow: 'column', position: 'fixed', bottom: 0 }}>
          <div style={{ display: 'flex', justifyContent: 'center', color:"#22394d" }}>
            <img style={{ display: "inline-flex", height: '1.4em' }} className={"jk-footer-image-cursor"} alt={"Powered by Velocity"} src={`${sourceUrl}/digit-footer.png`} onError={"this.src='./../digit-footer.png'"} onClick={() => {
              window.open('https://www.digit.org/', '_blank').focus();
            }}></img>
            <span style={{ margin: "0 10px" }}>|</span>
            <span style={{ cursor: "pointer", fontSize: "16px", fontWeight: "400"}} onClick={() => { window.open('https://niua.in/', '_blank').focus();}} >Velocity-Narendra</span>
            <span style={{ margin: "0 10px" }}>|</span>
        ...
        {loginScreens && <div style={{ width: '100%', position: 'fixed', bottom: 0 }}>
          ...
          <img style={{ display: "inline-flex", height: '1.4em' }} className={"jk-footer-image-cursor"} alt={"Powered by Velocity"} src={`${sourceUrl}/digit-footer-bw.png`} onError={"this.src='./../digit-footer.png'"} onClick={() => {
              window.open('https://www.digit.org/', '_blank').focus();
            }}></img>
            <span style={{ margin: "0 10px" }}>|</span>
            <span style={{ cursor: "pointer", fontSize: "16px", fontWeight: "400"}} onClick={() => { window.open('https://niua.in/', '_blank').focus();}} >Velocity-Narendra</span>
