  ...
  const inputs = (_config$inputs = config.inputs) === null || _config$inputs === void 0 ? void 0 : _config$inputs.map((input, index) => {
    if (input.type === "text") {
      if (input.name !== 'holdingId' && input.name !== 'mobileNumber') {
        ...
        return /*#__PURE__*/React.createElement(React.Fragment, {
          key: index
        }, /*#__PURE__*/React.createElement(CardLabel, null, t(input.label), " ", input.labelChildren && input.labelChildren), inValidHoldingId && /*#__PURE__*/React.createElement(CardLabelError, null, "Invalid Holding Id. Please provide the correct Holding Id Or Login with the Mobile Number"), errors[input.name] && /*#__PURE__*/React.createElement(CardLabelError, null, t(input.error)), /*#__PURE__*/React.createElement("div", {
          className: "field-container",
          style: {
            justifyContent: "left"
          }
          ...
          disable: input.disable ? input.disable : false,
          textInputStyle: textInputStyle
        })), config.inputs.length > 1 ? /*#__PURE__*/React.createElement("h1", null, "OR") : "");
