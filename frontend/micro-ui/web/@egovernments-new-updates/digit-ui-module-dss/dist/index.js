...
const DateRange = _ref => {
  ...
  const [selectionRange, setSelectionRange] = React.useState(values);
...
const Filters = _ref => {
  ...
  const [selected, setSelected] = React.useState(() => ulbTenants === null || ulbTenants === void 0 ? void 0 : ulbTenants.ulb.filter(tenant => {
  ...
  const [selectService, setSelectedService] = React.useState(() => services === null || services === void 0 ? void 0 : services.filter(module => (value === null || value === void 0 ? void 0 : value.moduleLevel) === (module === null || module === void 0 ? void 0 : module.code)));
  React.useEffect(() => {
  ...
  const selectedDDRs = React.useMemo(() => selected.map(ulb => ulbTenants.ulb.filter(e => e.code === ulb.code)[0]).filter((item, i, arr) => i === arr.findIndex(t => t.ddrKey === item.ddrKey)), [selected, ulbTenants]);
  const handleClear = () => {
    setValue({
      denomination: "Unit",
  ...
  })), !isNational && showModuleFilter && /*#__PURE__*/React__default.createElement("div", {
    className: "filters-input"
  }, /*#__PURE__*/React__default.createElement("div", {
    className: "mbsm"
  }, t("ES_DSS_SERVICES")), /*#__PURE__*/React__default.createElement(digitUiReactComponents.Dropdown, {
    option: services,
    optionKey: "name",
...
const Filters$1 = _ref => {
  ...
  const [selectedSt, setSelectedSt] = React.useState(() => {
    var _ulbTenants$ddr;
...
const CustomAreaChart = _ref => {
  ...
  const [totalWaste, setTotalWaste] = React.useState(0);
  const [keysArr, setKeysArr] = React.useState([]);
  const [manageChart, setmanageChart] = React.useState("Area");
  ...
  const renderTooltipForLine = _ref3 => {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    dataKey: "name"
  }), /*#__PURE__*/React__default.createElement(recharts.YAxis, null), /*#__PURE__*/React__default.createElement(recharts.Tooltip, {
...
const CustomHorizontalBarChart = _ref => {
  ...
  return /*#__PURE__*/React__default.createElement(React.Fragment, null, /*#__PURE__*/React__default.createElement(recharts.ResponsiveContainer, {
    ...
    tickCount: 10,
    tickFormatter: tickFormatter
  }), bars === null || bars === void 0 ? void 0 : bars.map((bar, id) => /*#__PURE__*/React__default.createElement(recharts.Bar, {
    key: id,
    dataKey: t(bar),
    fill: barColors[id],
...
const CustomPieChart = _ref => {
  ...
  const [isPieClicked, setIsPieClicked] = React.useState(false);
  const [pieSelected, setPieSelected] = React.useState(null);
...
const calculateFSTPCapacityUtilization = function (value, totalCapacity, numberOfDays) {
...
const CustomTable = _ref2 => {
  ...
  const [chartKey, setChartKey] = React.useState(id);
  ...
  const filterValue = React.useCallback(function (rows, id, filterValue) {
  ...
  const getDrilldownCharts = function (value, filterKey, label, filters) {
  ...
  const sortRows = React.useCallback((rowA, rowB, columnId) => {
  ...
  }, t("DSS_FILTERS_APPLIED"), ": "), filterStack.map((filter, id) => id > 0 ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
    key: id,
...
const GenericChart = _ref => {
  ...
  const [chartDenomination, setChartDenomination] = React.useState(null);
  const isMobile = window.Digit.Utils.browser.isMobile();
  ...
  }, t("TIP_" + Digit.Utils.locale.getTransformedLocale(header))))), chip.length < 2 && subHeader && /*#__PURE__*/React__default.createElement("p", {
    style: {
      color: "#505A5F",
      fontWeight: 700
    }
...
const MetricData = _ref => {
  ...
  }, indexValuesWithStar !== null && indexValuesWithStar !== void 0 && indexValuesWithStar.includes(code) ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.Rating, {
...
const Layout = _ref => {
  ...
  const [searchQuery, onSearch] = React.useState("");
  const [chip, updateChip] = React.useState({});
  ...
  const renderVisualizer = function (visualizer, key, chip, onChipChange, moduleCode) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: "chart-row"
  }, rowData.vizArray.map(React.useCallback((chart, key) => {
...
const DashBoard = _ref => {
  ...
  return /*#__PURE__*/React__default.createElement(FilterContext.Provider, {
    ...
    className: "tag-container"
  }, !showFilters && (filters === null || filters === void 0 ? void 0 : (_filters$filters6 = filters.filters) === null || _filters$filters6 === void 0 ? void 0 : _filters$filters6.tenantId) && filters.filters.tenantId.slice(0, 5).map((filter, id) => /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
    key: id,
    text: t("DSS_HEADER_ULB") + ": " + t(filter),
    onClick: () => removeULB(id)
  })), (filters === null || filters === void 0 ? void 0 : (_filters$filters7 = filters.filters) === null || _filters$filters7 === void 0 ? void 0 : (_filters$filters7$ten = _filters$filters7.tenantId) === null || _filters$filters7$ten === void 0 ? void 0 : _filters$filters7$ten.length) > 6 && /*#__PURE__*/React__default.createElement(React.Fragment, null, showFilters && filters.filters.tenantId.map((filter, id) => /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
    key: id,
    text: t("DSS_HEADER_ULB") + ": " + t(filter),
    onClick: () => removeULB(id)
    ...
    className: "tag-container"
  }, !showFilters && (filters === null || filters === void 0 ? void 0 : (_filters$filters9 = filters.filters) === null || _filters$filters9 === void 0 ? void 0 : _filters$filters9.state) && filters.filters.state.slice(0, 5).map((filter, id) => /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
    key: id,
    text: t("DSS_HEADER_STATE") + ": " + t("DSS_TB_" + Digit.Utils.locale.getTransformedLocale(filter)),
    onClick: () => removeST(id)
  })), (filters === null || filters === void 0 ? void 0 : (_filters$filters10 = filters.filters) === null || _filters$filters10 === void 0 ? void 0 : (_filters$filters10$st = _filters$filters10.state) === null || _filters$filters10$st === void 0 ? void 0 : _filters$filters10$st.length) > 6 && /*#__PURE__*/React__default.createElement(React.Fragment, null, showFilters && filters.filters.state.map((filter, id) => /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
    key: id,
    text: t("DSS_HEADER_STATE") + ": " + t("DSS_TB_" + Digit.Utils.locale.getTransformedLocale(filter)),
    onClick: () => removeST(id)
  })), !showFilters && /*#__PURE__*/React__default.createElement("p", {
    ...
    className: "tag-container"
  }, !showFilters && (filters === null || filters === void 0 ? void 0 : (_filters$filters12 = filters.filters) === null || _filters$filters12 === void 0 ? void 0 : _filters$filters12.ulb) && filters.filters.ulb.slice(0, 5).map((filter, id) => /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
    key: id,
    text: t("DSS_HEADER_ULB") + ": " + t("DSS_TB_" + Digit.Utils.locale.getTransformedLocale(filter)),
    onClick: () => removeTenant(id)
  })), (filters === null || filters === void 0 ? void 0 : (_filters$filters13 = filters.filters) === null || _filters$filters13 === void 0 ? void 0 : (_filters$filters13$ul = _filters$filters13.ulb) === null || _filters$filters13$ul === void 0 ? void 0 : _filters$filters13$ul.length) > 6 && /*#__PURE__*/React__default.createElement(React.Fragment, null, showFilters && filters.filters.ulb.map((filter, id) => /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
    key: id,
    text: t("DSS_HEADER_ULB") + ": " + t("DSS_TB_" + Digit.Utils.locale.getTransformedLocale(filter)),
    onClick: () => removeTenant(id)
  })), !showFilters && /*#__PURE__*/React__default.createElement("p", {
    ...
    className: "tag-container"
  }, !showFilters && (filters === null || filters === void 0 ? void 0 : filters.moduleLevel) && /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
...
const MapChart = _ref => {
  ...
  const mapData = (_get = lodash.get(topoJSON, "objects.india.geometries", [])) === null || _get === void 0 ? void 0 : _get.map(ee => {
    return {
  ...
  const onMouseEnter = function (geo, current, event) {
    if (current === void 0) {
      current = {
        value: "0"
      };
  ...
  const onMouseClick = function (geo, current, event) {
  ...
  const onMouseLeave = function (geo, current, event) {
    settooltipContent("");
  };
  ...
  return /*#__PURE__*/React__default.createElement(recharts.ResponsiveContainer, {
  ...
  }, /*#__PURE__*/React__default.createElement(ReactTooltip, null, tooltipContent), /*#__PURE__*/React__default.createElement(reactSimpleMaps.ComposableMap, {
    projectionConfig: PROJECTION_CONFIG,
    projection: "geoMercator",
    width: 240,
    height: 170,
    "data-tip": ""
  }, /*#__PURE__*/React__default.createElement(reactSimpleMaps.Geographies, {
    geography: topoJSON
  }, _ref2 => {
    let {
      geographies
    ...
    return geographies.map(geo => {
      ...
      return /*#__PURE__*/React__default.createElement(reactSimpleMaps.Geography, {
        key: geo.rsmKey,
        geography: geo,
...
const Chart$1 = _ref => {
  ...
  }, t("TIP_" + data.name)))), data.name === "NATIONAL_DSS_OVERVIEW_CITIZEN_FEEDBACK_SCORE" ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.Rating, {
...
const Home = _ref3 => {
  ...
  const [drillDownId, setdrillDownId] = React.useState("none");
  const [totalCount, setTotalCount] = React.useState("");
  const [liveCount, setLiveCount] = React.useState("");
  ...
  return /*#__PURE__*/React__default.createElement(FilterContext.Provider, {
    ...
    onClick: handlePrint
  }, /*#__PURE__*/React__default.createElement(digitUiReactComponents.DownloadIcon, null), t("ES_DSS_DOWNLOAD"))) : null, dashboardConfig === null || dashboardConfig === void 0 ? void 0 : (_dashboardConfig$9 = dashboardConfig[0]) === null || _dashboardConfig$9 === void 0 ? void 0 : _dashboardConfig$9.visualizations.map((row, key) => {
    return /*#__PURE__*/React__default.createElement("div", {
      className: "dss-card",
      key: key
...
const DrillDown = _ref => {
  ...
  return /*#__PURE__*/React__default.createElement(FilterContext.Provider, {
    ...
    text: t("DSS_HEADER_ULB") + ": " + t("DSS_TB_" + Digit.Utils.locale.getTransformedLocale(filter)),
    onClick: () => removeULB(id)
  })), (filters === null || filters === void 0 ? void 0 : (_filters$filters7 = filters.filters) === null || _filters$filters7 === void 0 ? void 0 : (_filters$filters7$ten = _filters$filters7.tenantId) === null || _filters$filters7$ten === void 0 ? void 0 : _filters$filters7$ten.length) > 6 && /*#__PURE__*/React__default.createElement(Fragment, null, showFilters && filters.filters.tenantId.map((filter, id) => /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
    key: id,
    text: t("DSS_HEADER_ULB") + ": " + t("DSS_TB_" + Digit.Utils.locale.getTransformedLocale(filter)),
    onClick: () => removeULB(id)
  })), !showFilters && /*#__PURE__*/React__default.createElement("p", {
    ...
    text: t("DSS_HEADER_STATE") + ": " + t("DSS_TB_" + Digit.Utils.locale.getTransformedLocale(filter)),
    onClick: () => removeST(id)
  })), (filters === null || filters === void 0 ? void 0 : (_filters$filters10 = filters.filters) === null || _filters$filters10 === void 0 ? void 0 : (_filters$filters10$st = _filters$filters10.state) === null || _filters$filters10$st === void 0 ? void 0 : _filters$filters10$st.length) > 6 && /*#__PURE__*/React__default.createElement(Fragment, null, showFilters && filters.filters.state.map((filter, id) => /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
    key: id,
    text: t("DSS_HEADER_STATE") + ": " + t("DSS_TB_" + Digit.Utils.locale.getTransformedLocale(filter)),
    onClick: () => removeST(id)
  })), !showFilters && /*#__PURE__*/React__default.createElement("p", {
    ...
    text: t("DSS_HEADER_ULB") + ": " + t("DSS_TB_" + Digit.Utils.locale.getTransformedLocale(filter)),
    onClick: () => removeTenant(id)
  })), (filters === null || filters === void 0 ? void 0 : (_filters$filters13 = filters.filters) === null || _filters$filters13 === void 0 ? void 0 : (_filters$filters13$ul = _filters$filters13.ulb) === null || _filters$filters13$ul === void 0 ? void 0 : _filters$filters13$ul.length) > 6 && /*#__PURE__*/React__default.createElement(Fragment, null, showFilters && filters.filters.ulb.map((filter, id) => /*#__PURE__*/React__default.createElement(digitUiReactComponents.RemoveableTag, {
    key: id,
    text: t("DSS_HEADER_ULB") + ": " + t("DSS_TB_" + Digit.Utils.locale.getTransformedLocale(filter)),
    onClick: () => removeTenant(id)
  })), !showFilters && /*#__PURE__*/React__default.createElement("p", {
...
const About = () => {
  ...
  }, t("DSS_ABOUT_DASHBOARD")), /*#__PURE__*/React__default.createElement(digitUiReactComponents.Card, null, moduleAbout.map(obj => {
...
const Routes = _ref2 => {
  ...
  }, /*#__PURE__*/React__default.createElement(FAQsSection, null)), /*#__PURE__*/React__default.createElement(reactRouterDom.Route, {
    key: "national-about",
    path: path + "/national-about"
  }, /*#__PURE__*/React__default.createElement(About, null))));
};
const DSSModule = _ref3 => {
  let {
    stateCode,
    userType,
    tenants
