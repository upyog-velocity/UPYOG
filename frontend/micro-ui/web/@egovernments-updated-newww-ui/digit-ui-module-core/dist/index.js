...
const Login = _ref => {
  ...
  const [inValidHoldingId, setInValidHoldingId] = React.useState(false);
  ...
  const selectMobileNumber = function (mobileNumber) {
    try {
      ...
      const data = {
        ...
        propertyIdEnabled: CitizenHomePageTenantId === null || CitizenHomePageTenantId === void 0 ? void 0 : CitizenHomePageTenantId.propertyIdEnabled
      };
        ...
        if (isUserRegistered) {
          return Promise.resolve(sendOtp({
            ...
            if (response.length > 0 && response[0]) {
              ...
              var _response$, _response$$response, _response$$response$d, _response$$response$d2;
              setCanSubmitNo(true);
              console.log(response);
              let isregister = ((_response$ = response[1]) === null || _response$ === void 0 ? void 0 : (_response$$response = _response$.response) === null || _response$$response === void 0 ? void 0 : (_response$$response$d = _response$$response.data) === null || _response$$response$d === void 0 ? void 0 : (_response$$response$d2 = _response$$response$d.error) === null || _response$$response$d2 === void 0 ? void 0 : _response$$response$d2.message) === 'Invalid Holding Id. Please provide the correct Holding Id.' ? true : false;
              if (isregister) {
          ...
          if (isUserRegistered) {
            ...
            const _temp = function () {
              if (!isUserRegistered) {
                ...
                return Promise.resolve(Digit.UserService.registerUser(requestData, stateCode)).then(function (_ref5) {
...
const Home$1 = _ref => {
  ...
  const ModuleLevelLinkHomePages = modules.map((_ref3, index) => {
    ...
    }), window.innerWidth <= 660 ? /*#__PURE__*/React__default.createElement("img", {
      src: "https://velocity-upyog-assets.s3.ap-south-1.amazonaws.com/mobile_banner_3.png"
    }) : /*#__PURE__*/React__default.createElement("img", {
      src: "https://velocity-upyog-assets.s3.ap-south-1.amazonaws.com/home_banner_3.png"   ,
      alt: "noimagefound"
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, "Developed & Supported by: ", /*#__PURE__*/React__default.createElement("br", null), " ", /*#__PURE__*/React__default.createElement("a", {
    href: "https://www.velsof.com/",
    target: "_blank",
    style: {
      textDecoration: "underline"
    }
  }, "Velocity Software Solutions Pvt. Ltd.")), /*#__PURE__*/React__default.createElement("span", {
    style: {
      margin: "0 10px",
      fontSize: window.Digit.Utils.browser.isMobile() ? "12px" : "14px"
    }
    ...
    href: "#",
    target: "_blank"
  }, "Platform ", /*#__PURE__*/React__default.createElement("b", null, "UPYOG")), /*#__PURE__*/React__default.createElement("span", {
    className: "upyog-copyright-footer",
    style: {
      margin: "0 10px",
      fontSize: window.Digit.Utils.browser.isMobile() ? "12px" : "14px"
  ...
  }, "Supported by: ", /*#__PURE__*/React__default.createElement("br", null), /*#__PURE__*/React__default.createElement("img", {
