...
public class ElasticSearchService {
    ...
    void initalizeSystemuser(){
        ...
        requestInfo.setAction("_update");
        requestInfo.setDid("1");
        requestInfo.setKey("");
        requestInfo.setMsgId("20170310130900|en_IN");
        requestInfo.setAuthToken("ec6a2db1-c000-4927-af21-f4ce13c1d75f");
        User user = new User();
        user.setId(23287L);
        user.setUuid("b777db1c-28ad-42b1-b950-6007f185b426");
        user.setName("Internal Microservice User Test22");
        user.setUserName("Internal Microservice User Test22");
        user.setEmailId(null);
        user.setMobileNumber("9949032246");
        user.setType("SYSTEM");
        List<Role> roleLIst = new ArrayList();
        Role role = new Role();
        role.setCode("INTERNAL_MICROSERVICE_ROLE");
        role.setName("Internal Microservice User");
        role.setTenantId("pg.citya");
        roleLIst.add(role);
        ...
        userSearchRequest.put("name","Internal Microservice User Test22");
        userSearchRequest.put("userName","Internal Microservice User Test22");
